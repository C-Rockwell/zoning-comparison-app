# CODEBASE LIBRARY — Detailed Reference

> Consult when `CODEBASE_NAV.md` doesn't have enough info. Store actions, factory functions, hooks, z-map, component hierarchy, API endpoints, migrations.
